...
install:
	...
	helm upgrade -i fargocd charts/fargocd --wait \
...
uninstall:
	@cd ../installer; \
	helm uninstall fargocd --namespace=$(KUBE_NAMESPACE) || true
...
docker-certify-redhat:
	@preflight check container $(IMAGE):$(VERSION_UBI) \
		--submit \
		--certification-component-id=6957a1996efca96b72c0f6da
